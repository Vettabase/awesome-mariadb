...
* [How to run Mariadb in Docker and Connect Remotely](https://www.youtube.com/watch?v=OabTOPOU2RU) (video)
* [How to Install & Use MariaDB with PHP](https://www.seidengroup.com/php-documentation/using-mariadb-with-php/) on IBM i
...
* [Is InnoDB Buffer Pool big enough?](https://vettabase.com/is-innodb-buffer-pool-big-enough/) and [Can we shrink InnoDB Buffer Pool?](https://vettabase.com/can-we-shrink-innodb-buffer-pool/)
...
| [Databasement](https://github.com/David-Crty/databasement)            | YES                                  | [MIT](https://github.com/David-Crty/databasement/blob/main/LICENSE) | Self-hosted backup manager with web UI. Schedule, backup, and restore MySQL, PostgreSQL, MariaDB, SQLite & Redis to S3, SFTP, or local storage. |
...
| [myflames](https://github.com/vgrippa/myflames)                                      | YES                            | [CDDL-1.0](https://github.com/vgrippa/myflames/blob/master/LICENSE)                                                                                                                                                           | Python                     | Visualizes MariaDB `ANALYZE FORMAT=JSON` (and MySQL `EXPLAIN ANALYZE FORMAT=JSON`) as interactive SVG flame graphs, bar charts, treemaps, and Visual Explain diagrams. Includes an advisor panel with tuning suggestions. Stdlib-only, no external dependencies. |
...
| [ReliaDB EXPLAIN Analyzer](https://github.com/Mughees52/mysql-explain-analyzer) | YES | [MIT](https://github.com/Mughees52/mysql-explain-analyzer/blob/main/LICENSE) | TypeScript (Vue 3) | Browser-based MariaDB and MySQL EXPLAIN visualizer with issue detection, index recommendations, and query rewrites. Supports MariaDB ANALYZE table and JSON formats. 100% client-side. |
