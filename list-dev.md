...
| Node.js              | [Connector/Node.js](https://mariadb.com/kb/en/about-mariadb-connector-nodejs/)            | YES             | <ul><li>[AUTHed25519]</li><li>[BULK](https://github.com/mariadb-corporation/mariadb-connector-nodejs/blob/master/documentation/batch.md)</li><li>AUTHparsec([3.4.0](https://mariadb.com/kb/en/mariadb-connector-node-js-3-4-0-release-notes/))</li><li>NOconfigSSL([3.3.0](https://mariadb.com/kb/en/mariadb-connector-node-js-3-3-0-release-notes/))</li></ul>*The list might be incomplete.*    |
...
| PHP         | [RedBeanPHP](https://www.redbeanphp.com/) | [New BSD/GPL 2](https://www.redbeanphp.com/index.php?p=/license) | YES | NOT VERIFIED |
